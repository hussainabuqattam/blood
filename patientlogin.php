<?php
    ...
    if(isset($_POST['login'])) {
        ...
        if ($count > 0) {
            ...
            $_SESSION['patient_ID'] = $getUser['id'];
...
<form class="login-form" method="post">
                <h1 style="margin-bottom:60px">Patient Login</h1>
                ...
                <p style="text-align: center;margin-top:50px;">Does not have an account ? <a style="text-decoration: none;" href="patientsignup.php">Click here to register</a></p>
